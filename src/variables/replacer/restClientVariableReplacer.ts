...
export class RestClientVariableReplacer implements VariableReplacer {
  type = VariableReplacerType.restClientDynamic;
  async replace(text: string, _type: VariableType | string, { variables }: ProcessorContext): Promise<string | undefined> {
